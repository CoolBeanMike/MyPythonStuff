"""
craping Numbers from HTML using BeautifulSoup In this assignment you will write a Python program similar to
...
Actual data: http://py4e-data.dr-chuck.net/comments_62810.html (Sum ends with 83)
